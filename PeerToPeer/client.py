...
rfc_numbers = [123, 2345]
rfc_titles = ['A Proferred Official ICP', 'Domain Names and Company Name Retrieval']
rfc_hostname = 'thishost.csc.ncsu.edu'
rfc_last_modified = ['Thu, 21 Jan 2001 9:23:46 GMT', 'Fri, 21 Apr 2023 16:05:00 GMT']
rfc_data = ['A Proferred Official ICP', 'Domain Names and Company Name Retrieval']
VER = 'P2P-CI/1.0'
upload_port = 5678
